<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contract_Audit.aspx.cs" Inherits="WebSite5_production_Contract_Audit" %>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 " "><br />
                        <h3 class="text-center"> CONTRACT AUDIT DIRECTORY</h3>
                               </div>
            ...
            <tbody> 
              <%Response.Write(getAllAudits()); %>
              
                </tbody>
            </table>
                        
                         <button type='button'  class='audit-btn btn btn-primary col-md-12' >Process</button>
            ...
            $(document).ready(function () {
             //   $("#success-alert").hide();
                $(".audit-btn").click(function () {
                    var confirmation = confirm("are you sure you want to Process ?");
                    ...
                    $(":checkbox").each(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'Contract_Audit.aspx/ContractProcess',
                            contentType: "application/json; charset=utf-8",
                            data: "{'contract_NO':'" + vals + "'}",
                            async: false,
