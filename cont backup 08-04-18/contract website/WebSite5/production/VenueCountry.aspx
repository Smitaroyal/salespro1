<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VenueCountry.aspx.cs" Inherits="WebSite5_production_VenueCountry" %>
...
<body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3" id="venueCountryID">
                  <div class="form-group">
                      <label for="sel1">Venue Country ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3" id="venueCountryName">
                  <div class="form-group">
                      <label for="sel1">Venue Country Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" runat="server"></asp:TextBox>
                  </div>
              </div>

               <div class="col-md-3" id="venueCountryStatus">
                  <div class="form-group">
          ...
          <div class="col-md-12 " ">
        <h3 class="text-center"> VENUE COUNTRY DIRECTORY</h3>
  ...
  <div class="row">
           ...
           <div class="col-md-4 col-md-offset-4" >
            ...
            <thead>
                <tr>
                    <th>VENUE COUNTRY ID</th>
                    
                    <th>VENUE COUNTRY NAME</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var venueCountryName = $("#TextBox2").val();
                var status = $("#status").val();
                alert(venueCountryName);
                alert(status);

                $.ajax({

                    type:'Post',
                    url: 'VenueCountry.aspx/insertVenueCountry',
                    contentType:"application/json; charset=utf-8",
                    data: "{'venuecountryname':'" + venueCountryName + "','status':'" + status + "'}",
                    async: false,
                    success: function (data) {
                        $("#TextBox2").val("");
                        $("#status").val('');
                  
                        alert("Venue Country added successfully")
                    },
                    error: function () {
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#head").hide();
                $("#venueCountryName").hide();
                $("#venueCountryStatus").hide();
                $("#directory").hide();
                $("#insert").hide();

                $("#insertButton").click(function () {
                    $("#head").show();
                    $("#venueCountryName").show();
                    $("#venueCountryStatus").show();
                    $("#status").val('');
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'VenueCountry.aspx/getAllVenueCountry',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>"+value1[2]+"</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var venueCountryID = row.find("td:eq(0)").text();
                    var venueCountryName = row.find("td:eq(1)").text();
                    var confirmation = confirm("are you sure you want to delete " + venueCountryName + " ?");

                    if (confirmation) {

                        $.ajax({
                            type: 'POST',
                            url: 'VenueCountry.aspx/deleteVenueCountry',
                            contentType: "application/json; charset=utf-8",
                            data: "{'venueCountryID':'" + venueCountryID + "'}",
                            async: false,
                            success: function (data) {

                                alert("Venue Country deleted successfully!!");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var venueCountryID = $("#TextBox1").val();
                    var venueCountryName = $("#TextBox2").val();
                    var status = $("#status").val();
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'VenueCountry.aspx/updateVenueCountry',
                        contentType: "application/json; charset=utf-8",
                        data: "{'venuecountryID':'" + venueCountryID + "','venuecountryName':'" + venueCountryName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
                            $("#status").val('');
                            alert("Venue Country updated successfully!!");
