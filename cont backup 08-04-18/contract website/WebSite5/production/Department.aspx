<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="WebSite5_production_Department" %>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-2">
                ...
                <button type="button" id="insert" class="btn btn-primary pull-right btn-block">Insert</button>
                 
                
                     <button type="button" id="update" class="btn btn-primary pull-right btn-block">update</button>
                  <!--  <asp:Button ID="Button2" runat="server" class="btn btn-primary pull-right btn btn-block" Text="Update" />-->
              </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var deptCode = $("#TextBox2").val();
                var deptName = $("#TextBox3").val();
                ...
                $.ajax({
                    ...
                    data: "{'deptcode':'"+deptCode+"','deptname':'"+deptName+"','status':'"+status+"'}",
                    async: false,
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-6' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-6' >Delete</button></td></tr>");
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var deptCode = row.find("td:eq(0)").text();
                    //alert(deptCode);
                    var deptName = row.find("td:eq(1)").text();
        
                    var confirmation = confirm("are you sure you want to delete " + deptName + " ?");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var deptCodeID = $("#TextBox2").val();
                    var departmentName = $("#TextBox3").val();
                    var status = $("#status").val();
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'deptID':'" + deptCodeID + "','departmentName':'" + departmentName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
