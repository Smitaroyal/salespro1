<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gift_Option.aspx.cs" Inherits="WebSite5_production_Gift_Option" %>
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD GIFT</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          ...
          <div class="col-md-12 " ">
        <h3 class="text-center"> GIFT DIRECTORY</h3>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Gift_Option.aspx/insertGift',
                    contentType:"application/json; charset=utf-8",
                    data: "{'giftname':'" + giftName + "','status':'" + status + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Gift_Option.aspx/getAllGifts',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var giftID = row.find("td:eq(0)").text();
                    var giftName = row.find("td:eq(1)").text();
                    var confirmation = confirm("are you sure you want to delete " + giftName + " ?");

                    if (confirmation){
                        $.ajax({
                            type: 'POST',
                            url: 'Gift_Option.aspx/deleteGifts',
                            contentType: "application/json; charset=utf-8",
                            data: "{'giftID':'" + giftID + "'}",
                            async: false,
                            success: function (data) {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Gift_Option.aspx/updateGifts',
                        contentType: "application/json; charset=utf-8",
                        data: "{'giftID':'" + giftID + "','giftName':'" + giftName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
                            $("#status").val('');
                            alert("Gifts updated successfully!!");
