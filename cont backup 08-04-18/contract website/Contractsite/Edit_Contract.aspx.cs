...
public partial class Contractsite_Edit_Contract : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
           ...
           // contsalesrepDropDownList.Items.Add(ds5.Tables[0].Rows[0]["Contract_Finance_Sales_Rep"].ToString());
            ...
            DataSet dsec19 = Queries2.LoadTOManager(officeo, VenueDropDown, vencountry);
            ...
            DataSet dsec20 = Queries2.LoadButtonUp(officeo, VenueDropDown, vencountry);
            ...
            else if (conttype == "Points")
            {
                ...
                TextInitDepo.Text = ds5.Tables[0].Rows[0]["PS_Initial_Deposit"].ToString();
                TextBalDepo.Text = ds5.Tables[0].Rows[0]["PS_Bal_Deposit"].ToString();
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        if (conttype == "Fractional")
        {
            ...
            if (icnt == 0)
            {
                ...
                for (i = 1; i <= int.Parse(PANoOfInstallF); i++)
                {
                    ...
                    //{
                    string finaInstI = Queries2.getFinanceInstallID(officeo);
                    int FinanceInvoice = Queries2.InsertFinanceInv(finaInstI, desc, date, amot1, curr, GenContNumb, ProfileIDo, PA, officeo, fracido,DateTime.Now);
                    // }
            ...
            int contup = Queries2.UpdateFracPS(Deposit_PM,  DepositF,  AdmissFeesF,  AdminFeesF,  PurchasePriceF,  BalanceDuePAF, PANoOfInstallF,  PAFirstPayDateF,  PAAmountInstallF,  PAFirstInstallF,  BalanceDueDatesPAF, RemarksF,  EuroRatesF,  AusRatesF,  GbpRatesF,  IdaRatesF, YearOfInterestP, TotalBalanceF, DateTime.Now.ToString(), fracido, InitDepof, BalDepof, DepoDatef, BalanceDueDatesPAF2, RemarksF2,CPAF);

            int contFina = Queries2.UpdateContFrac(affilice, affilhp, salesrep, tomanager, buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, ID_Card, CrownCurr, fracido, DealRegDate,ft1,ft2,DateTime.Now,cweekno);

            int contFinadetails = Queries2.UpdateFinanceDetails(tPurchase1,  QDepo1,  AmtCre1,  CreCurr1,  NoOfMonth1,  RateOfInt1,  MonthlyRepay1, fracido, MonthlyRepay110, MonthlyRepay1Payprotectcharge, PayProtect,FinaDate);
        ...
        else if(conttype=="Points")
        {
            ...
            if (icnt == 0)
            {
                ...
                for (i = 1; i <= int.Parse(PANoOfInstallP); i++)
                {
                    ...
                    {
                        string finaInstI = Queries2.getFinanceInstallID(officeo);
                        int FinanceInvoice = Queries2.InsertFinanceInv(finaInstI, desc, date, amot2, curr, GenContNumb, ProfileIDo, SA, officeo, fracido, DateTime.Now);
                    }
        ...
        else if(conttype == "Trade Into Points")
        {
            ...
            int contup = Queries2.UpdatePointPS(Deposit_PM, DepositP, DepoPPA, DepositSAP, AdmissFeesP, ApplicationFeesP, AdminFeesP, AdminServiceP, PurchasePriceP, TotalServicePriceP, CoutryTaxP, GrandTotalP, BalanceDuePAP, BalanceDueSAP, PANoOfInstallP, PAFirstPayDateP, PAAmountInstallP, PAFirstInstallP, BalanceDueDatesPAP, BalanceDueDatesSAP, RemarksP, TotalBalance, EuroRatesF, AusRatesF, GbpRatesF, IdaRatesF, YearOfInterestP, DateTime.Now.ToString(), fracido, InitDepotp, BalDepotp, DepoDatetp, remarkTP2, BalanceDueDatesPATP2, BalanceDueDatesSATP2,CPATP);
            int contFina = Queries2.UpdateContFrac(affilice, affilhp, salesrep, tomanager, buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, ID_Card, CrownCurr, fracido, DealRegDate, ft1, ft2, DateTime.Now,cweekno);
        ...
        else if (conttype == "Trade Into Fractional")
        {
            ...
            int contup = Queries2.UpdateFracPS(Deposit_PM, DepositF, AdmissFeesF, AdminFeesF, PurchasePriceF, BalanceDuePAF, PANoOfInstallF, PAFirstPayDateF, PAAmountInstallF, PAFirstInstallF, BalanceDueDatesPAF, RemarksF, EuroRatesF, AusRatesF, GbpRatesF, IdaRatesF, YearOfInterestP, TotalBalanceF, DateTime.Now.ToString(), fracido, InitDepotf ,BalDepotf ,DepoDatetf ,BalanceDueDatesPATF2, RemarksTF2,CPATF);
