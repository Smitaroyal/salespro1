...
public partial class Contractsite_ReportPage : System.Web.UI.Page
{
    ...
    private void show_report()
    {
        ...
        DataTable dt = Queries2.loadDGRBALI1(TextBox4.Text,TextBox2.Text,TextBox3.Text);
        ...
        ReportParameter[] rptParam = new ReportParameter[]
        {
            new ReportParameter("DATE",TextBox4.Text),
             new ReportParameter("Office",TextBox2.Text),
             new ReportParameter("venue",TextBox3.Text)
