...
function displayI() {
    ...
    //var kk1 = document.getElementById("DealDrawerDropDownList").value;

    //alert(kk1);

    //var dealstat = kk1.options[kk1.selectedIndex].text;//document.getElementById("DealDrawerDropDownList").value;
  ...
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextFFina1,#TextFFina2,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2{
      ...
      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#Textcheckchs4,#Button9,#Button13,#Button7,#Button12,#Button10,#tButton1,#Button11,#Button14,#pbala,#fbala,#tpbala,#tfbala,#F50,#P50,#TF50,#TP50,#cpacom
      {
    display:none;
      }
           ...
           <div id="contract-container">
            <div id="cleft" style=" width:605px;">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr >
                        <td width="300px"></td>
                        <td width="300px"><asp:Label ID="Label57" runat="server" Text="Label">Entitlement- 50%</asp:Label><asp:CheckBox ID="FCheckBox1" runat="server" /></td>
                ...
                <div id="cdiv2" style="margin:5px 5px;">
                    ...
                    <tr >
                        <td width="300px"></td>
                        <td width="300px"><asp:Label ID="Label58" runat="server" Text="Label">Entitlement- 50%</asp:Label><asp:CheckBox ID="PCheckBox1" runat="server" /></td>
            ...
            <div id="cdiv4" style="margin:5px 5px;">
                ...
                <table cellpadding="5px" cellspacing="5px"  >
                    ...
                    <tr >
                        <td width="300px"></td>
                        <td width="300px"><asp:Label ID="Label60" runat="server" Text="Label">Entitlement- 50%</asp:Label><asp:CheckBox ID="TPCheckBox1" runat="server" /></td>
