...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  $( function () {
      ...
      $("#myBtnNext").click(function () {
         ...
         // alert(selected);
          // $("#tabs").tabs("option", "active", parseInt(selected) + 1);
          if(selected == '0')
          {
              document.getElementById('myBtnBack').style.display = 'block';
           ...
           $(document).ready(function () {
               $("#ContTypeDropDownListTF").change(function () {
                   ...
                   if (conttype == "From Points To Fractional" && Currtype == "USD") {
                      // alert('From Points To Fractional');
...
///for property fees
           ...
           $(document).ready(function () {
               ...
               $("#VenueDropDownList").change(function () {
                   ...
                   $.ajax({
                       ...
                       contentType: "application/json; charset=utf-8",
                       //url is the path of our web method (Page name/function name)
                       url: "contracts.aspx/SalesRepTypeList",
                       data: "{'venueid': '" + id + "','countid' : '" + id2 + "'}",
                       dataType: "json",
                       //called on jquery ajax call success
                       success: function (data) {
           ...
           $(document).ready(function () {
               var id;
               var vk = document.getElementById("CrownFinanceCurrDropDownList");
               var id2k = vk.options[vk.selectedIndex].text;
             ...
             //  if (id2k == 'USD')
              ...
              // }
               ...
               $("#CrownFinanceCurrDropDownList").change(function () {
                  // alert("hi");
                   //id = $("#CrownFinanceCurrDropDownList").val();
       ...
       <script type="text/javascript">
           ...
           function pele(kk) {
               ...
               //window.location = '<%= ResolveUrl("contracts.aspx") %>';

               $(function () { $('#tabs').tabs({ disabled: [2, 3, 4] }); $('#tabs').tabs({ active: 1 }); });
               return false;
           }
          ...
          /* function othercurrency()
           ...
           function initinstall()
           {
               ...
               var idate,iiamt,inoi;
               if (conttypeinit == "Points")
               {
                   ...
                   document.getElementById("TextIniInstAmtP").value = Math.round(parseInt(document.getElementById("TextBalDepo").value) / parseInt(document.getElementById("TextIniInstP").value));
                   iiamt = document.getElementById("TextIniInstAmtP").value;
                   datetoi2(idate,inoi,iiamt);
               }
...
function datetoi2(idate, inoi, iiamt)
{
    //alert('dateoi2');
       ...
       // if (payn == "Points") {
        ...
        if (payn == "Points") {
           ...
           // document.getElementById('TextRemarksF2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoF").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text14;
            ...
            document.getElementById('TextRemarksTF').value = texttp13 + " " +text13;
            document.getElementById('TextRemarksTF2').value = texttp14 + " "+ text14;
           ...
           // document.getElementById('TextRemarksTF2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTF").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text14;
            ...
            //k = text13;
            document.getElementById(j).value = texttp13 + " " +text13;
            document.getElementById(k).value = texttp14 + " " + text14;
        }
    ...
    //"Balance Deposit " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDP").value + " " +
        ...
        if (dropval == "Points") {
            ...
            else if (dealstat == "Deal")
            {
                ...
                document.getElementById('TextPBalanceDDates2').value = text15;
                document.getElementById('TextBalanceDDatesSAP2').value = text16;
            }
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextDueDatesPAF').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoF").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text13;
                document.getElementById('TextDueDatesPAF2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoF").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text15;
            }
            else if (dealstat == "Deal")
            {
                document.getElementById('TextDueDatesPAF').value = text13;
                document.getElementById('TextDueDatesPAF2').value = text15;
            }
            //document.getElementById('TextBalanceDDatesSAP').value = text14;
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextBalanceDueDatesPATP').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTP").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text13;
                document.getElementById('TextBalanceDueDatesSATP').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTP").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text14;
                document.getElementById('TextBalanceDueDatesPATP2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTP").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text15;
                document.getElementById('TextBalanceDueDatesSATP2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTP").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text16;
            }
            else if (dealstat == "Deal") {
                document.getElementById('TextBalanceDueDatesPATP').value = text13;
                document.getElementById('TextBalanceDueDatesSATP').value = text14;
                document.getElementById('TextBalanceDueDatesPATP2').value = text15;
                document.getElementById('TextBalanceDueDatesSATP2').value = text16;
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextBalanceDueDatesPATF').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTF").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text13;
                document.getElementById('TextBalanceDueDatesPATF2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTF").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text15;
            }
            else if (dealstat == "Deal") {
                document.getElementById('TextBalanceDueDatesPATF').value = text13;
                document.getElementById('TextBalanceDueDatesPATF2').value = text15;
...
function TotalPointsCalc()
{
  ...
  function hi3()
      ...
      document.getElementById('<%= salesrepDropDownList.ClientID %>').style.backgroundColor = '#ffffff';
        ...
        if (id == '')
        {
            //alert('VenueCountryDropDownList');
       ...
       if (id7 == '')
        {
           //alert('primarynationalityDropDownList');
           ...
           if (id8 == '')
        {
               //alert('PrimaryCountryDropDownList');
           ...
           if (id9 == '')
        {
          ...
          <%-- if (id10 == '')
        {
               //alert('employmentstatusDropDownList');
           ...
           if (id11 == '')
        {
              // alert('MaritalStatusDropDownList');
    ...
    function val2()
    {
        ...
        var rem = true;
        var cam;
        var v1k = document.getElementById("DropDownList40");
        var idmain = v1k.options[v1k.selectedIndex].text;
       ...
       // alert(id2);
        ...
        else if (idmain == 'Trade Into Fractional')
        {
            //ContTypeDropDownListTF
        ...
        else if (idmain == 'Trade Into Points')
        {
           ...
           function loadFirstcrowncurr() {
              //alert('CallPageMethod');
               ...
               $.ajax({
                   ...
                   contentType: "application/json; charset=utf-8",
                   //url is the path of our web method (Page name/function name)
                   url: "contract.aspx/pnumberCount",
                   data: "{'id': '" + id + "'}",
                   dataType: "json",
                   //called on jquery ajax call success
                   success: function (data) {
       ...
       <script>
           ...
           //    var p = document.getElementById("PayMethodDropDownList").value;
           //    alert("kkkk"+p);
           //    if (p == 'Crown Finance') {
           //        alert('pp');
           //        loadFirstcrowncurr();
               ...
               //var v13 = document.getElementById("VenueDropDownList");
               //var id3 = v13.options[v13.selectedIndex].text;

               //var v22 = document.getElementById("VenueCountryDropDownList");
               //var id2 = v22.options[v22.selectedIndex].text;
  ...
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextFFina1,#TextFFina2,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2{
      ...
      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#pbala,#fbala,#tpbala,#tfbala,#F50,#P50,#TF50,#TP50,#cpacom
      {
    display:none;
      }
...
<input id="chsp5" type="checkbox" onclick="shows5();"/>
 <label for="chsp5">SUB PROFILE 4</label>      
     ...
     <br />
        ...
        <br />
        <asp:CheckBox ID="Regterms1" runat="server" Text="Registration Card Terms" />
    ...
    <div id="tabs-2" style="background-color:#e9e9e9">
       ...
       <div id="contract_tab" style="margin-top:10px;margin-left:5px;margin-right:5px; margin-bottom:10px; overflow:hidden; ">
          ...
          <asp:DropDownList ID="DropDownList40" runat="server"  Width="200px" style="height: 25px" onchange="contracttype();CurrencyFees();">
            ...
            <div id="cleft" style=" width:605px;">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <td width="300px"><asp:DropDownList ID="EntitlementFracDropDownList"  runat="server" Width="200px" onchange="Ent50();"></asp:DropDownList></td>
                    </tr>
                    </table>
                    <table id="F50">
                    <tr >
               ...
               <div id="ffractional1" >
                ...
                <table cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="TextDepositF" runat="server" Enabled="True" Width="328px" onchange="adminfee();"></asp:TextBox></td>
                    </tr>
                    </table>
                       ...
                       <table id="fbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDF" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                             ...
                             <tr>
                               <td width="180px"><asp:Label ID="Label67" runat="server" Text="Label">No Of Installment</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstF" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="180px"><asp:Label ID="Label68" runat="server" Text="Label">Installment Amount</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstAmtF" runat="server" Enabled="True" Width="328px" onclick="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td><asp:Button ID="InitF" runat="server" Text="Modify Invoices" OnClientClick="btnclick2();return false;" /></td>
                               <td></td>
                           </tr>
                           </table>
              ...
              <div class="points_col" style="margin:10px 0px;padding-top:10px;">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="TextDepositP" runat="server" Enabled="True" Width="328px" onchange="adminfee();"></asp:TextBox></td>
                    </tr>

                </table>
                       <table id="pbala"  cellpadding="5px" cellspacing="5px">
                           <tr>
                               <td width="210px"><asp:Label ID="Label44" runat="server" Text="Label">Initial Deposit</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextInitDepo" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label45" runat="server" Text="Label">Balance Deposit</asp:Label></td>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           ...
                           <tr>
                               <td width="210px"><asp:Label ID="Label63" runat="server" Text="Label">No Of Installment</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label64" runat="server" Text="Label">Installment Amount</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstAmtP" runat="server" Enabled="True" Width="328px" onclick="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td><asp:Button ID="initP" runat="server" Text="Modify Invoices" OnClientClick="btnclick2();return false;" /></td>
                               <td></td>
                           </tr>
                           </table>
              ...
              <div id="tfractional" >
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="TextDepositTF" runat="server" Enabled="True" Width="328px" onchange="adminfee();"></asp:TextBox></td>
                    </tr>
                    </table>

                     <table id="tfbala"  cellpadding="5px" cellspacing="5px">
                           <tr>
                               <td width="180px"><asp:Label ID="Label48" runat="server" Text="Label">Initial Deposit</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextInitDepoTF" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="180px"><asp:Label ID="Label49" runat="server" Text="Label">Balance Deposit</asp:Label></td>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDTF" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                         ...
                         <tr>
                               <td width="180px"><asp:Label ID="Label69" runat="server" Text="Label">No Of Installment</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstTF" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="180px"><asp:Label ID="Label79" runat="server" Text="Label">Installment Amount</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstAmtTF" runat="server" Enabled="True" Width="328px" onclick="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td><asp:Button ID="InitTF" runat="server" Text="Modify Invoices" OnClientClick="btnclick2();return false;" /></td>
                               <td></td>
                           </tr>
                           </table>
              ...
              <div id="tpoints" >
               <div class="tpoints_col" style=" margin:10px 0px;padding-top:10px;">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        <td width="210px">
                           <asp:Label ID="Label180" runat="server" Text="Label">Deposit</asp:Label>
                        </td>  
                        ...
                        <asp:TextBox ID="TextDepositTP" runat="server" Enabled="True" Width="328px" onchange="adminfee();"></asp:TextBox></td>
                    </tr>

                    </table>
                       <table id="tpbala"  cellpadding="5px" cellspacing="5px">
                           <tr>
                               <td width="210px"><asp:Label ID="Label50" runat="server" Text="Label">Initial Deposit</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextInitDepoTP" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label51" runat="server" Text="Label">Balance Deposit</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextBalDepoTP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label55" runat="server" Text="Label">Next Balance Deposit Date</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextBoxNBDTP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label65" runat="server" Text="Label">No Of Installment</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstTP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td width="210px"><asp:Label ID="Label66" runat="server" Text="Label">Installment Amount</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextIniInstAmtTP" runat="server" Enabled="True" Width="328px" onclick="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                               <td><asp:Button ID="initTP" runat="server" Text="Modify Invoices" OnClientClick="btnclick2();return false;" /></td>
                               <td></td>
                           </tr>
                           </table>
              ...
              <div id="myModal2" class="modal2">
                  <div class="modal-content2">
                      ...
                      <p>Change Installment Amount</p>
                        <br />
                        <br />
                        <asp:Label ID="Label60" runat="server" Text="Label">Initial Deposit</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp
