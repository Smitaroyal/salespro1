<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Country.aspx.cs" Inherits="WebSite5_production_Country" %>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 " "><br />
                        <h3 class="text-center"> COUNTRY DIRECTORY</h3>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var countryName = $("#TextBox2").val();
                var countryCode = $("#TextBox3").val();
                //alert(countryName);
                //alert(countryCode);
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Country.aspx/insertCountry',
                    contentType:"application/json; charset=utf-8",
                    data: "{'countryname':'"+countryName+"','countrycode':'"+countryCode+"'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Country.aspx/getAllCountries',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var countryID = row.find("td:eq(0)").text();
                    var countryName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + countryName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Country.aspx/deleteCountry',
                            contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'countryid':'" + countryID + "','countryname':'" + countryName + "','countrycode':'" + countryCode + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
