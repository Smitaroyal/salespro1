    ...
    if (dealstat == "Top Drawer") {
        ...
        if (payn == "Points") {
           ...
           // alert(p + " " + text13);
            ...
            document.getElementById('TextRemarksF').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text13;
            document.getElementById('TextRemarksF2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text14;
        }
        else if (payn == "Trade Into Fractional") {
            document.getElementById('TextRemarksTF').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text13;
            document.getElementById('TextRemarksTF2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text14;
        }
            ...
            // alert(d);
            document.getElementById(j).value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text13;
            document.getElementById(k).value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text14;
...
function displayI() {
    ...
    //"Balance Deposit " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDP").value + " " +
        ...
        if (dropval == "Points") {
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextDueDatesPAF').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text13;
                document.getElementById('TextDueDatesPAF2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDF").value + "; " + text15;
            }
            else if (dealstat == "Deal")
            {
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextBalanceDueDatesPATP').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text13;
                document.getElementById('TextBalanceDueDatesSATP').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text14;
                document.getElementById('TextBalanceDueDatesPATP2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text15;
                document.getElementById('TextBalanceDueDatesSATP2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTP").value + "; " + text16;
            }
            else if (dealstat == "Deal") {
            ...
            if (dealstat == "Top Drawer") {
                document.getElementById('TextBalanceDueDatesPATF').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text13;
                document.getElementById('TextBalanceDueDatesPATF2').value = "Balance Deposit " + document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text15;
            }
            else if (dealstat == "Deal") {
          ...
          function cardremark(card, comment)
           {
              ...
              if(dropval=="Points")
              {
                  document.getElementById(comment).value = document.getElementById("TextRemarkP2").value;
              }
              else if (dropval=="Fractional")
              {
                  document.getElementById(comment).value = document.getElementById("TextRemarksF2").value;
              }
              else if (dropval == "Trade Into Fractional")
              {
                  document.getElementById(comment).value = document.getElementById("TextRemarksTF2").value;

              }
              else if (dropval == "Trade Into Points") {
                  document.getElementById(comment).value = document.getElementById("TextRemarksTP2").value;
  ...
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextFFina1,#TextFFina2,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2{
      ...
      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#pbala,#fbala,#tpbala,#tfbala
      {
    display:none;
      }
