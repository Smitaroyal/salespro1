        ...
        if (!Page.IsPostBack)
        {
          ...
          //  SecCountryDropDownList.DataBind();
           ...
           // salesrepDropDownList.Items.Add(ds4.Tables[0].Rows[0]["Tour_Details_Guest_Sales_Rep"].ToString());
            ...
            DataSet ds19 = Queries2.LoadTOManager(officeo, VenueDropDownListval);
            ...
            DataSet ds20 = Queries2.LoadButtonUp(officeo, VenueDropDownListval);
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int ContractFinance = Queries2.InsertContractFinance(contfinaid, GenContNumb, ContType, affilice, affilhp, salesrep, tomanager,
                buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, BPaymethod, Pan, Adhar, ID_Card, ProfileIDo, officeo, CrownCurr, DealRegDate);
            string log1 = "Contract Finance: " + "Finance_ID:" + contfinaid + "," + "Finance_Cont_Numb:" + GenContNumb + "," + "Finance_Cont_Type:" + ContType + "," + "Finance_Affil_ICE:" + affilice + "," + "Finance_Affil_HP:" + affilhp + "," + "Finance_Sales_Rep:" + salesrep + "," + "Finance_TO_Manager:" + tomanager + "," + "Finance_Button_UP:" + buttonup + "," + "Finance_Currency:" + FinaCurrency + "," + "Finance_Purchase_Price:" + PurchasePrice + "," + "Finance_Admin_Fees:" + AdminFees + "," + "Finance_MC_Fees:" + MCFees + "," + "Finance_Deal_Drawer:" + DealDrawer + "," + "Finance_Payment_Method:" + PaymentMethod + "," + "Finance_Finance_Num:" + FinanceNumb + "," + "Finance_BPayment_Method:" + BPaymethod + "," + "Finance_Pan_Card:" + Pan + "," + "Finance_Adhar_Card:" + Adhar + "," + "Finance_ID_Card:" + ID_Card + "," + "Profile ID:" + ProfileIDo + "," + "Crown Finance Curr:" + CrownCurr + "," + "Deal Reg Date:" + DealRegDate;
            ...
            string script = "<script> $(function() { $('#tabs').tabs({ disabled: [] }); $( '#tabs' ).tabs({ active: 4 }); }); document.getElementById('myBtnNext').style.display = 'none'; callallfunc();</script> ";
            //  this.Page.ClientScript.RegisterStartupScript(typeof(Page), "alert", script);
            ScriptManager.RegisterStartupScript(this, typeof(Page), "alert", script, false);
