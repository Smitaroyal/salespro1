<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Agent.aspx.cs" Inherits="WebSite5_production_Agent" %>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3" id="agentName">
               ...
               <div class="col-md-3" id="agentStatus">
                  <div class="form-group">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 " "><br />
                        <h3 class="text-center"> AGENT DIRECTORY</h3>
                               </div>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Agent.aspx/insertAgent',
                    contentType:"application/json; charset=utf-8",
                    data: "{'agentName':'" + agentName + "','status':'" + status + "','office':'" + office + "'}",
                    async: false,
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var agentID = row.find("td:eq(0)").text();
                    var agentName = row.find("td:eq(1)").text();
                    //alert(agentID);
                    var confirmation = confirm("are you sure you want to delete " + agentName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Agent.aspx/deleteAgents',
                            contentType: "application/json; charset=utf-8",
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var agentID = $("#TextBox1").val();
                    var agentName = $("#TextBox2").val();
                    var agentStatus = $("#status").val();
                    var office = $("#office").val();
               
                    $.ajax({
                        type: 'POST',
                        url: 'Agent.aspx/updateAgents',
                        contentType: "application/json; charset=utf-8",
                        data: "{'agentID':'" + agentID + "','agentName':'" + agentName + "','agentStatus':'" + agentStatus + "','office':'" + office + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
