<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Group.aspx.cs" Inherits="WebSite5_production_User_Group" %>
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD USER GROUP</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3" id="userGroupID">
                  <div class="form-group">
                      <label for="sel1">User Group ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3" id="userGroupName">
                  <div class="form-group">
                      <label for="sel1">User Group Name:</label>
          ...
          <div class="col-md-12 " ">
        <h3 class="text-center"> USER GROUP DIRECTORY</h3>
              <br />
              </div>
              </div> <div class="row">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var userGroupName = $("#TextBox2").val();
             
                $.ajax({

                    type:'Post',
                    url: 'User_Group.aspx/insertUserGroup',
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'User_Group.aspx/getAllUserGroup',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var userGroupID = row.find("td:eq(0)").text();
                    var userGroupName = row.find("td:eq(1)").text();
                    var confirmation = confirm("are you sure you want to delete " + userGroupName + " ?");
                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'User_Group.aspx/deleteUserGroup',
                            contentType: "application/json; charset=utf-8",
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'User_Group.aspx/updateUserGroup',
                        contentType: "application/json; charset=utf-8",
