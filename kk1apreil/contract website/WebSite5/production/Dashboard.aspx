            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><%Response.Write(getSignUps()); %></div>
                    <br />
                  <h3>New Sign ups</h3>
                  <p></p>
                </div>
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><%Response.Write(getTopSalesRep()); %></div>
                  <h3>Top Sales Rep</h3>
                  <p></p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><% Response.Write(getDeals()); %></div>
                        <br />
                  <h3>Deals Registered</h3>
                  <p></p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count"><% Response.Write(getCancelledDeals()); %></div>
                        <br />
                  <h3>Deals Cancelled</h3>
                  <p></p>
                </div>
              </div>
            </div>
