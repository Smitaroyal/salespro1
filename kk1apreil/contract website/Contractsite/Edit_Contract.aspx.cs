...
public partial class Contractsite_Edit_Contract : System.Web.UI.Page
{
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        string tPurchase1, QDepo1, AmtCre1, CreCurr1, NoOfMonth1, RateOfInt1, MonthlyRepay1, MonthlyRepay110, MonthlyRepay1Payprotectcharge, PayProtect; ;
        ...
        {
            int finadetails = Queries2.Update_Finance_Details(tPurchase1, QDepo1, AmtCre1, CreCurr1, NoOfMonth1, RateOfInt1, MonthlyRepay1, fracido, MonthlyRepay110, MonthlyRepay1Payprotectcharge, PayProtect);
        }
        //else { }
        ...
        if (conttype == "Fractional")
        {
            ...
            int contFina = Queries2.UpdateContFrac(affilice, affilhp, salesrep, tomanager, buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, ID_Card, CrownCurr, fracido, DealRegDate,ft1,ft2,DateTime.Now);

            int contFinadetails = Queries2.UpdateFinanceDetails(tPurchase1,  QDepo1,  AmtCre1,  CreCurr1,  NoOfMonth1,  RateOfInt1,  MonthlyRepay1, fracido, MonthlyRepay110, MonthlyRepay1Payprotectcharge, PayProtect);
